      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <RevealOnScroll delay={100}>
            <div className="coc-card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".18em", color:"rgba(0,255,127,.3)", marginBottom:".35rem" }}>01 / PLEDGE</p>
          ...
          <RevealOnScroll delay={200}>
            <div>
              <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".18em", color:"rgba(0,255,127,.3)", marginBottom:".5rem" }}>02 / STANDARDS</p>
          ...
          <RevealOnScroll delay={300}>
            <div className="coc-card">
              <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".18em", color:"rgba(0,255,127,.3)", marginBottom:".35rem" }}>03 / ENFORCEMENT</p>
              ...
              {ENFORCEMENT.map(({ step, title, impact, consequence }) => (
                <div key={step} className="enf-row">
                  <div style={{ display:"flex", alignItems:"center", gap:".7rem", marginBottom:".35rem" }}>
                    <span style={{ fontFamily:"monospace", fontSize:".58rem", letterSpacing:".15em", color:"rgba(0,255,127,.35)" }}>{step}</span>
          ...
          <RevealOnScroll delay={400}>
            <div className="coc-card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".18em", color:"rgba(0,255,127,.3)", marginBottom:".35rem" }}>04 / SCOPE</p>
          ...
          <RevealOnScroll delay={500}>
            <div style={{ border:"1px solid rgba(0,255,127,.22)", background:"rgba(0,255,127,.04)", padding:"2rem", position:"relative", overflow:"hidden" }}>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".18em", color:"rgba(0,255,127,.3)", marginBottom:".35rem" }}>05 / REPORTING</p>
