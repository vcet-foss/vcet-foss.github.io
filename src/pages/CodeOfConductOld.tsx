            ...
            <div className="max-w-4xl mx-auto px-6 lg:px-8">
                ...
                <RevealOnScroll delay={100}>
                    <section className="mb-12 border border-white/10 bg-white/[0.02] p-8">
                        <div className="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-display font-bold text-white mb-4 jersey-25-regular tracking-wide text-3xl">
                                    Our Pledge
                                </h2>
                ...
                <RevealOnScroll delay={200}>
                    <section className="mb-12">
                        <h2 className="text-2xl font-display font-bold text-white mb-6 jersey-25-regular tracking-wide text-3xl">
                            Our Standards
                        </h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="border border-white/10 bg-white/[0.02] p-6">
                                <h3 className="text-lg font-mono text-foss-green mb-4 jersey-25-regular tracking-wide text-xl">
                                    ✓ Expected Behavior
                                </h3>
                            ...
                            <div className="border border-red-500/20 bg-red-500/[0.02] p-6">
                                <h3 className="text-lg font-mono text-red-400 mb-4 flex items-center gap-2 jersey-25-regular tracking-wide text-xl">
                ...
                <RevealOnScroll delay={300}>
                    <section className="mb-12 border border-white/10 bg-white/[0.02] p-8">
                        ...
                        <div className="space-y-6 text-gray-400 font-sans">
                            <div>
                                <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">1. Correction</h3>
                                <p className="text-sm">
                            ...
                            <div>
                                <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">2. Warning</h3>
                                <p className="text-sm">
                            ...
                            <div>
                                <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">3. Temporary Ban</h3>
                                <p className="text-sm">
                            ...
                            <div>
                                <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">4. Permanent Ban</h3>
                                <p className="text-sm">
