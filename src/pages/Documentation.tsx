            ...
            <div className="grid md:grid-cols-3 gap-3">
              {[
                ...
                <NavLink key={to} to={to} className="quick-link">
                  <div style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".18em", color:"rgba(0,255,127,.6)", marginBottom:".25rem" }}>{label}</div>
            ...
            <RevealOnScroll key={s.id} delay={150 + i * 80}>
              <div className="doc-card">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".15em", color:"rgba(0,255,127,.3)", marginBottom:".2rem" }}>{s.idx}</p>
