                                ...
                                <RevealOnScroll key={h.id} delay={i * 100}>
                                    <div className="hk-card">
                                        <div style={{ position: "absolute", top: "1rem", right: "1rem" }}>
                                            <span style={{ padding: "3px 10px", border: "1px solid rgba(0,255,127,.3)", fontFamily: "monospace", fontSize: ".75rem", letterSpacing: ".15em", color: "rgba(0,255,127,.7)", background: "rgba(0,255,127,.06)" }}>
                                                UPCOMING
                                            </span>
                                        </div>
                                        <p style={{ fontFamily: "monospace", fontSize: ".85rem", letterSpacing: ".15em", color: "rgba(0,255,127,.3)", marginBottom: ".6rem" }}>
                                        ...
                                        <p style={{ fontFamily: "monospace", fontSize: ".85rem", letterSpacing: ".1em", color: "rgba(0,255,127,.6)", marginBottom: "1rem" }}>
                                            THEME: {h.theme}
                                        </p>
                                ...
                                <RevealOnScroll key={h.id} delay={i * 100}>
                                    <div className="hk-card">
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div>
                                                <p style={{ fontFamily: "monospace", fontSize: ".75rem", letterSpacing: ".15em", color: "rgba(255,255,255,.22)", marginBottom: ".5rem" }}>
                                                ...
                                                <p style={{ fontFamily: "monospace", fontSize: ".85rem", letterSpacing: ".1em", color: "rgba(0,255,127,.5)", marginBottom: ".9rem" }}>THEME: {h.theme}</p>
                                            ...
                                            {h.winner && (
                                                <div style={{ borderLeft: "1px solid rgba(255,255,255,.07)", paddingLeft: "2rem" }}>
                                                    <div className="flex items-center gap-2 mb-4">
                                                        <Trophy className="w-4 h-4 text-yellow-400" />
                                                        <span style={{ fontFamily: "monospace", fontSize: ".75rem", letterSpacing: ".15em", color: "rgb(250,204,21)", fontWeight: 700 }}>WINNER</span>
                                                    </div>
                                                    ...
                                                    <p style={{ fontFamily: "monospace", fontSize: ".75rem", letterSpacing: ".12em", color: "rgba(255,255,255,.28)", marginBottom: ".3rem" }}>TEAM MEMBERS</p>
