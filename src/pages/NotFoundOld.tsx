    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center px-6 relative overflow-hidden">
            ...
            <div className="max-w-3xl w-full text-center relative z-10">
                <RevealOnScroll>
                    {/* Main 404 Message */}
                    <h1 className="text-8xl md:text-9xl font-display font-bold mb-6 jersey-25-regular">
                        <span className="text-white">4</span>
                        <span className="text-foss-green animate-pulse">0</span>
                        <span className="text-white">4</span>
                    </h1>

                    <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4 jersey-25-regular">
                        Lost in the Void?
                    </h2>
