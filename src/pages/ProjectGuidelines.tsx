            ...
            <div className="pg-card">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".15em", color:"rgba(0,255,127,.3)", marginBottom:".3rem" }}>01</p>
          ...
          <RevealOnScroll delay={200}>
            <div className="pg-card">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".15em", color:"rgba(0,255,127,.3)", marginBottom:".3rem" }}>02</p>
          ...
          <RevealOnScroll delay={300}>
            <div className="pg-card">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".15em", color:"rgba(0,255,127,.3)", marginBottom:".3rem" }}>03</p>
          ...
          <RevealOnScroll delay={400}>
            <div className="pg-card">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".15em", color:"rgba(0,255,127,.3)", marginBottom:".3rem" }}>04</p>
          ...
          <RevealOnScroll delay={500}>
            <div style={{ border:"1px solid rgba(239,68,68,.2)", background:"rgba(239,68,68,.02)", padding:"2rem", position:"relative", overflow:"hidden" }}>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p style={{ fontFamily:"monospace", fontSize:".6rem", letterSpacing:".15em", color:"rgba(239,68,68,.4)", marginBottom:".3rem" }}>05</p>
