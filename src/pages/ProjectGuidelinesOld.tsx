                        ...
                        <div className="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">✓ Write Clean Code</h3>
                                    ...
                                    <div>
                                        <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">✓ Testing</h3>
                                        <ul className="space-y-1 text-gray-400 text-sm font-sans ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">✓ Documentation</h3>
                                        <ul className="space-y-1 text-gray-400 text-sm font-sans ml-4">
                        ...
                        <div className="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <div className="space-y-4 text-gray-400 font-sans text-sm">
                                    <div>
                                        <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">1. Branch Naming</h3>
                                    ...
                                    <div>
                                        <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">2. Commit Messages</h3>
                                    ...
                                    <div>
                                        <h3 className="text-white font-mono text-sm mb-2 jersey-25-regular tracking-wide text-xl">3. Pull Requests</h3>
                                        <ul className="space-y-1 ml-4">
